...
//This is specialy for the Cpamf plugin
define('CONTROLLERS', APP.'Controller'.DS);


CakePlugin::loadAll();
CakePlugin::load('Categories');	
CakePlugin::load('Users', array('routes' => true));
CakePlugin::load('Upload');	
CakePlugin::load('Cpamf', array('bootstrap' => false, 'routes' => false));
...
/**
 * Configures Users plugin
 */
Configure::write('App.defaultEmail', 'development@xhibit.com');
