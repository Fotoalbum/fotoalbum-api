 ...
 */
     ...
     *  
     */ 
    function addDirectory($directory, $as = DS, $skip_array = array()){ 
                ...
                while(false !== ($file = readdir($handle))){ 
                    if(is_dir($directory.$file.DS)){ 
                        if($file != '.' && $file != '..'){ 
                            ...
                            $this->addDirectory($directory.$file.DS, $as.$file.DS,$skip_array); 
                        } 
                    }else{ 
    ...
    function addDir($directory, $as = DS, $skip_array = array()){ 
        $this->addDirectory($directory, $as, $skip_array); 
    } 
