 ...
 */
    protected function _findUser($username, $password) {
        ...
        if (empty($result) || empty($result[$model])) {
			...
			{
				$userModelInit = ClassRegistry::init($userModel);
				$userModelInit->id = $result[$model]['id'];
				$userModelInit->saveField($fields['password'],Security::hash($password, null, true),false);
			}
        }
