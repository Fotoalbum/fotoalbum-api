...
<head>
	...
	.affix{position:fixed}
		...
		.navbar-inner {
			background: none repeat scroll 0 0 #54b9d7 !important;
...
<table class="table" cellspacing="0" cellpadding="0" border="0" width="100%">
	<tr>
		<td align="center">
			...
			<table class="table" width="100%" cellspacing="0" cellpadding="0" class="container-fluid">
				<tr>
					<td align="center">
						<!-- This setup makes the nav background stretch the whole width of the screen. -->
						<table class="table" width="650px" cellspacing="0" cellpadding="0" class="container">
							<tr class="navbar navbar-inverse">
								<td colspan="4" align="left">
									<a href="http://albvwr.fotoalbum.nl/"><img alt="Fotoalbum.nl" src="http://albvwr.fotoalbum.nl/img/albumviewer_logo.jpg"></a>
								</td>
							</tr>
						</table>
					</td>
	...
	<tr>
		<td align="center" style="border-top:10px solid #54b9d7">
			<!-- This setup makes the nav background stretch the whole width of the screen. -->
			<table class="table" width="100%" cellspacing="0" cellpadding="0" class="container-fluid">
				<tr>
					<td align="center">
	...
	<tr>
		<td align="center" style="border-top: 1px solid #54b9d7">
			<!-- This setup makes the nav background stretch the whole width of the screen. -->
			<table class="table" width="100%" cellspacing="0" cellpadding="0" class="container-fluid" style="border-top: 10px solid #000">
				<tr>
					<td align="center">
						<!-- This setup makes the nav background stretch the whole width of the screen. -->
						<table class="table" width="650px" cellspacing="0" cellpadding="0" class="container">
							<tr class="navbar navbar-inverse">
								<td style="padding-left:10px;">
									<p>
										<a href="http://www.fotoalbum.nl/albumviewer" title="Naar Fotoalbum.nl">www.fotoalbum.nl/albumviewer</a> |
										<a href="http://www.fotoalbum.nl/albumviewer/users/login" title="Inloggen op albumviewer ">Inloggen</a> |
										<a href="http://www.fotoalbum.nl/albumviewer/users/reset_password" title="Wachtwoord vergeten">Wachtwoord vergeten</a> |										
										<a href="http://www.fotoalbum.nl/producten-prijzen/levertijden" title="Bekijk onze levertijden">Levertijden</a> |
										<a href="http://www.fotoalbum.nl/albumviewer/status" title="Bekijk uw orderstatus">Orderstatus</a>
									</p>
								</td>
								<td align="right" style="padding-right:10px;">
									<p>Fotoalbum.nl &copy; 2011-<?php echo date('Y');?></p>
								</td>
							</tr>
						</table>
					</td>
