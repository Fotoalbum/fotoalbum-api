<div class="memberships index row">
...
<div class="col-md-10 span10">
	...
	<tr>
		...
		<td><?php echo h($membership['Membership']['code']); ?>&nbsp;</td>
		<td class="actions">
			<div class="btn-toolbar">
				<div class="btn-group">
					<?php echo $this->Html->link(__('View'), array('action' => 'view', $membership['Membership']['id']), array('class' => 'btn btn-default btn-xs')); ?>
					<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $membership['Membership']['id']), array('class' => 'btn btn-default btn-xs')); ?>
					<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $membership['Membership']['id']), array('class' => 'btn btn-danger btn-xs'), __('Are you sure you want to delete # %s?', $membership['Membership']['id'])); ?>
				</div>
			</div>
		</td>
	</tr>
