<div class="printerProducts row">
	<div class="actions col-md-3 col-md-3">
		<ul class="nav nav-list">
			<li class="nav-header"><?php echo __('Actions'); ?></li>
	
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PrinterProduct.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PrinterProduct.id'))); ?></li>
	...
	<div class="printerProducts col-md-9 col-md-9">
												
	<?php echo $this->Form->create('PrinterProduct', array('inputDefaults' => array( 'class' => 'input-xxlarge', 'div' => 'control-group', 'label' => array('class' => 'control-label'), 'wrapInput' => 'controls'), 'class' => 'form-horizontal'));?>
		<fieldset>
			<legend><?php echo __('Edit Printer Product'); ?></legend>
		<?php
