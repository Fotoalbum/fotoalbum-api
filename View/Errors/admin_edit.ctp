<div class="errors row">
	...
	<div class="errors col-md-6 span9">
												
	<?php echo $this->Form->create('Error', array('inputDefaults' => array( 'class' => 'form-control', 'div' => 'control-group', 'label' => array('class' => 'control-label'), 'wrapInput' => 'controls'), 'class' => 'form-horizontal'));?>
		<fieldset>
			<legend><?php echo __('Admin Edit Error'); ?></legend>
		<?php
