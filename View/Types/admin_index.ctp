...
<div class="col-md-10 span10">
	...
	<tr>
		...
		<td><?php echo h($type['Type']['foreign_model']); ?>&nbsp;</td>
		...
		<td class="actions">
			<div class="btn-toolbar">
				<div class="btn-group">
					...
					<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $type['Type']['id']), array('class' => 'btn btn-danger btn-xs'), __('Are you sure you want to delete # %s?', $type['Type']['id'])); ?>
				</div>
			</div>
		</td>
	</tr>
