<div class="types row">
	...
	<div class="types col-md-6 span9">
												
	<?php echo $this->Form->create('Type', array('inputDefaults' => array( 'class' => 'form-control', 'div' => 'control-group', 'label' => array('class' => 'control-label'), 'wrapInput' => 'controls'), 'class' => 'form-horizontal'));?>
		<fieldset>
