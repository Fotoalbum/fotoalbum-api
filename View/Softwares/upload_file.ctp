...
?>
<form accept-charset="utf-8" method="post" id="indexForm" enctype="multipart/form-data" action="/v2/softwares/upload_file/<?php echo $user_id;?>/bla/bla">
	...
	<fieldset>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="file" id="file" name="data[hires]">
			</div>
		</div>
		<div>
