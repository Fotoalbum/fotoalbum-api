<div class="printerProductCovers row">
	<div class="actions col-md-3 span3">
		<ul class="nav nav-list">
			<li class="nav-header"><?php echo __('Actions'); ?></li>
				...
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PrinterProductCover.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PrinterProductCover.id'))); ?></li>
	...
	<?php echo $this->Form->create('PrinterProductCover', array('inputDefaults' => array( 'class' => 'form-control', 'div' => 'control-group', 'label' => array('class' => 'control-label'), 'wrapInput' => 'controls'), 'class' => 'form-horizontal'));?>
		<fieldset>
			<legend><?php echo __('Admin Edit Printer Product Cover'); ?></legend>
		<?php
