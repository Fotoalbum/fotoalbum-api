<div class="colors row">
	...
	<div class="colors col-md-9 span9">
												
	<?php echo $this->Form->create('Color', array('inputDefaults' => array( 'class' => 'input-xxlarge', 'div' => 'control-group', 'label' => array('class' => 'control-label'), 'wrapInput' => 'controls'), 'class' => 'form-horizontal'));?>
		<fieldset>
