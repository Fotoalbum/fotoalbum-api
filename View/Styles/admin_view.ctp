<div class="styles view row">
	...
	<?php if (!empty($style['Background'])):?>
		...
		<th><?php echo __('Modified'); ?></th>
					...
					<?php
		$i = 0;
		foreach ($style['Background'] as $background): ?>
		<tr>
	...
	<?php if (!empty($style['Sticker'])):?>
		...
		<th><?php echo __('Modified'); ?></th>
					...
					<?php
		$i = 0;
		foreach ($style['Sticker'] as $sticker): ?>
		<tr>
