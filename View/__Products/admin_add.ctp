<div class="products row">
	...
	<?php echo $this->Form->create('Product', array('inputDefaults' => array( 'class' => 'form-control', 'div' => 'control-group', 'label' => array('class' => 'control-label'), 'wrapInput' => 'controls'), 'class' => 'form-horizontal'));?>
		...
		echo $this->Form->input('status', array('label'=>array('text'=>'Status (eventueel wel/niet tonen op site, niet meerleverbaar)'),'options'=>array('A'=> 'Actief','T'=>'Verwijderd','D'=>'Niet meer leverbaar')));
	?>
		<hr>
		<legend>Multipage options:</legend>		
	<?php
		...
		echo $this->Form->input('start_with', array('label'=>array('text'=>'Opties zijn: spread|page'),'options'=>array('spread','page')));
