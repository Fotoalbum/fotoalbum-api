<div class="backgroundStyles index row">
...
<div class="col-md-10 span10">
	<h2><?php echo __('Background Styles');?></h2>
	<table class="table table-condensed table-hover" style="white-space:nowrap;">
		...
		<tbody>
			<?php
			foreach ($backgroundStyles as $backgroundStyle): ?>
	<tr>
		<td><?php echo h($backgroundStyle['BackgroundStyle']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($backgroundStyle['BackgroundStyle']['created']); ?>&nbsp;</td>
		<td><?php echo h($backgroundStyle['BackgroundStyle']['modified']); ?>&nbsp;</td>
		<td class="actions">
			<div class="btn-toolbar">
				<div class="btn-group">
					<?php echo $this->Html->link(__('View'), array('action' => 'view', $backgroundStyle['BackgroundStyle']['id']), array('class' => 'btn btn-default btn-xs')); ?>
					<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $backgroundStyle['BackgroundStyle']['id']), array('class' => 'btn btn-default btn-xs')); ?>
					<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $backgroundStyle['BackgroundStyle']['id']), array('class' => 'btn btn-danger btn-xs'), __('Are you sure you want to delete # %s?', $backgroundStyle['BackgroundStyle']['id'])); ?>
				</div>
			</div>
		</td>
	</tr>
