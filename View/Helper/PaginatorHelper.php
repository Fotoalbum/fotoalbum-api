 ...
 * - `pager paging['paramType']` The type of parameters to use when creating links. Valid options are
...
/**
 * Gets the current pager paging parameters from the resultset for the given model
 *
 * @param string $model Optional model name. Uses the default if none is specified.
 * @return array The array of pager paging parameters for the paginated resultset.
 ...
 */
	public function first($first = '<< first', $options = array()) {
		...
		if (is_int($first) && $params['page'] >= $first) {
			...
			$options = array_merge($options,array('rel' => 'first'));
 ...
 */
	public function last($last = 'last >>', $options = array()) {
		...
		if (is_int($last) && $params['page'] <= $lower) {
			...
			$options = array_merge($options,array('rel' => 'last'));
