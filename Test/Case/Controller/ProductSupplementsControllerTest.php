<?php
App::uses('ProductSupplementsController', 'Controller');

/**
 * ProductSupplementsController Test Case
 *
 */
class ProductSupplementsControllerTest extends ControllerTestCase {
