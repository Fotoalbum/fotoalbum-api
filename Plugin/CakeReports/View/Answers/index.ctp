<div class="answers index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('answer_text'); ?></th>
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($answer['Response']['id'], array('controller' => 'responses', 'action' => 'view', $answer['Response']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($answer['Question']['id'], array('controller' => 'questions', 'action' => 'view', $answer['Question']['id'])); ?>
		</td>
		<td><?php echo h($answer['Answer']['answer_text']); ?>&nbsp;</td>
		<td class="actions">
