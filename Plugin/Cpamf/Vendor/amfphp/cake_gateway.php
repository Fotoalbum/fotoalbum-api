 ...
 * 	The cake_gateway is a customized entry point to call cakePHP controllers 

 * from flash/flex application. Works the same way, as AMFPHP/gateway.php Uses 

 * the same configuration from globals.php
 ...
 * @version $Id: cake_gateway.php 12 2009-04-02 12:41:02Z daniel.verner $
 ...
 */
	...
	$Id: cake_gateway.php 12 2009-04-02 12:41:02Z daniel.verner $
	...
	*/
	...
	define("PRODUCTION_SERVER", false);
	   ...
	   //error_log('web_ioi::cake_gateway.php');
